...
module RubySerial
  module Win32
    ...
    attach_function :CreateFileA,     %i[pointer uint32 uint32 pointer uint32 uint32 pointer], :pointer,
                    blocking: true
    attach_function :CloseHandle,     [:pointer], :int, blocking: true
    attach_function :ReadFile,        %i[pointer pointer uint32 pointer pointer], :int32, blocking: true
    attach_function :WriteFile,       %i[pointer pointer uint32 pointer pointer], :int32, blocking: true
